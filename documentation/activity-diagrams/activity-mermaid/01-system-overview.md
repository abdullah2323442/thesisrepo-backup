...
flowchart TD
    ...
    AssignStudents --> SetAOI[Set Group-AreaOfInterest Relations\n(Many-to-Many)]
    ...
    PanelReview --> FinalAnnotations[Panel Annotations\n(created_by_type: panel_member)]
    FinalAnnotations --> End([End])
    
    RunAssignment -.->|External APIs| APIs[BatchApiService\nStudentApiService\nSupervisorApiService]
