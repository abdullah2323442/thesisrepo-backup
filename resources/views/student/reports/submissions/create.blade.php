            ...
            <form action="{{ route('student.reports.submissions.store', $report) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    <label for="file" class="block text-sm font-medium text-gray-700 mb-2">
                        Upload Report File <span class="text-red-500">*</span>
                    </label>
                        ...
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-gray-600">
                                <label for="file" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                    ...
                                    <input id="file" name="file" type="file" accept=".pdf,.ppt,.pptx" required class="sr-only" onchange="updateFileName(this)">
                                </label>
                                <p class="pl-1">or drag and drop</p>
                            </div>
                            <p class="text-xs text-gray-500">PDF or PowerPoint files, up to 20MB</p>
