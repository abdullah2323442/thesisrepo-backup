...
@section('page-description', 'Review and provide feedback on student reports')
...
<div class="space-y-6">
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
        <div class="flex items-start gap-3">
            ...
            <div>
                <h3 class="text-sm font-semibold text-amber-800">Co-Supervisor Report Access</h3>
                <p class="text-sm text-amber-700 mt-1">
                    You can review reports, provide feedback, and mark them under review. 
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-gray-600">
                    {{ $reports->total() }} reports from {{ $groups->count() }} co-supervised groups
                </div>
            </div>
        </div>
        ...
        <div class="p-6">
            @if($reports->isEmpty())
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-600">No reports have been created for your co-supervised groups yet.</p>
                </div>
            @else
                <div class="space-y-4">
    ...
    <!-- Co-Supervised Groups Summary -->
    @if($groups->count() > 0)
        <div class="bg-white rounded-lg shadow">
            <div class="p-6 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">Your Co-Supervised Groups</h3>
            </div>
            <div class="p-6">
